...
//ürünleri aldigimiz API ile iletisim kurdugumuz fonksiyon
class Products {
  async getProducts() {
    try {
      let result = await fetch(
        "https://65d714d327d9a3bc1d7a1b98.mockapi.io/products"
      );
...
// API ' dan aldigimiz verileri  kullanacagımız fonksiyon
class UI {
  displayProducts(products) {
    let result = "";
    products.forEach((item) => {
      result += `
           <div class="coll-lg-4 col-md-6">
            <div class="product">
...
//Yüklendiginde gerceklesecek olaylar
document.addEventListener("DOMContentLoaded", () => {
  const ui = new UI();
  const products = new Products();

  //Sayfayi yuklediginda local storagedan verileri
